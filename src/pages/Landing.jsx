...
const DISCOVERY_CARDS = [
  {
    sub: "Internships, jobs & gigs tailored to your Discotive Score",
    color: "#60A5FA",
  ...
  {
    sub: "Build a verified portfolio and charge what you're worth",
    color: "#FBBF24",
  ...
  {
    sub: "SHA-256 verified credentials. Your proof, immutable.",
    color: "#38BDF8",
