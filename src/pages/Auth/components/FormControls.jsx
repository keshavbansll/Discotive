// src/pages/Auth/components/FormControls.jsx
import React, {
  useState,
  useRef,
  useEffect,
...
// Paste your Exact CustomSearchSelect here
export const CustomSearchSelect = React.memo(
  ({ options, value, onChange, placeholder, allowCustom, required }) => {
    /* ... your existing CustomSearchSelect implementation ... */
  },
);

// Paste your Exact CustomMultiSelect here
export const CustomMultiSelect = React.memo(
  ({ options, selected, onChange, placeholder, allowCustom }) => {
    /* ... your existing CustomMultiSelect implementation ... */
  },
);

// Paste your Exact OAuthButton and Icons here
